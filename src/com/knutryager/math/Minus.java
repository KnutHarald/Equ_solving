...
public class Minus extends BinaryOperator{
	...
	public Expression getDifferential() {
		return new Minus(arg1.getDifferential(),arg2.getDifferential());
	}
	...
	public Terms toTerms(){
		...
		ArrayList<Boolean> addyModes2 = (ArrayList<Boolean>) ary2.modes.clone();
		for(int i = 0; i < addyModes2.size(); i++){
			addyModes.add(!addyModes2.get(i));
		}
